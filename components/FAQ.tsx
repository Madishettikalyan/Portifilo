...
export default function FAQ() {
  ...
  return (
    <section className="py-24 relative overflow-hidden bg-dark-bg/60 border-t border-white/5" id="faq">
          ...
          {PORTFOLIO_DATA.faqs.map((faq, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className={`font-display font-bold text-base sm:text-lg transition-colors ${isOpen ? 'text-primary' : 'text-slate-200'}`}>
                    {faq.question}
                  </span>
